...
| 函数计算 | 函数计算 FC  | 云函数 SCF | 函数工作流 FunctionGraph | 函数计算 CFC | 函数计算 | AWS Lambda |
...
| 服务类型 | 阿里云 | 腾讯云 | 华为云 | 百度云 | 天翼云 | AWS |
|---------|--------|--------|--------|---------|---------|-----|
| 云原生数据库 MySQL | 云数据库 RDS MySQL | TDSQL-C MySQL版 | 云数据库 RDS MySQL | 云数据库 RDS MySQL | 云数据库 MySQL | Amazon RDS for MySQL |
| 云原生数据库 PostgreSQL | 云数据库 RDS PostgreSQL | TDSQL-C PostgreSQL版 | 云数据库 PostgreSQL | 云数据库 RDS PostgreSQL | 云数据库 PostgreSQL | Amazon RDS for PostgreSQL |
| 分布式数据库 MySQL | 分布式数据库 PolarDB-X | TDSQL MySQL版 | 分布式数据库中间件 | 分布式数据库 GaiaDB-X | - | Amazon Aurora |
...
| 云数据库 SQL Server | 云数据库 SQL Server | 云数据库 SQL Server | 云数据库 SQL Server | 云数据库 SQL Server | 云数据库 SQL Server | Amazon RDS for SQL Server |
| 云数据仓库 | 云原生数据仓库 AnalyticDB | 云数据仓库 TCHouse | 数据仓库服务 DWS | 云数据仓库 | 数据仓库 | Amazon Redshift |
| 云数据库 MongoDB | 云数据库 MongoDB | 云数据库 MongoDB | 文档数据库服务 DDS | 云数据库 MongoDB | 云数据库 MongoDB | Amazon DocumentDB |
...
| 向量数据库 | - | 向量数据库 | - | 向量数据库 VectorDB | - | Amazon OpenSearch |
...
| 数据库管理 DMC | 数据管理 DMS | 数据库管理 | 数据管理服务 | 数据库管理 | 数据库管理 | Amazon RDS Management Console |
| 数据传输服务 | 数据传输服务 DTS | 数据传输服务 DTS | 数据复制服务 DRS | 数据传输服务 | 数据传输服务 | AWS Database Migration Service |
| 数据库网关 | 数据库网关 DG | 数据库代理 | 数据库网关 | - | - | Amazon RDS Proxy |
| 数据库智能管家 | - | 数据库智能管家 DBbrain | - | - | - | - |
| 轻量数据库 | - | 轻量数据库 | - | - | - | - |
| 数据库性能优化 | - | - | 数据库性能优化服务 DAS | - | - | - |
| 表格存储 | - | - | - | 云数据库 TableStorage | - | - |
...
| 智能翻译 | - | 腾讯同传 | - | - | - | - |
| 语音技术 | - | - | - | 语音能力引擎 SPEECH | - | - |
| 智能数智人 | - | 腾讯智能数智人 | - | 曦灵数字人平台 | - | - |
| 大模型开发平台 | - | - | - | 千帆大模型平台 | - | - |
| 大模型应用开发平台 | - | - | - | 千帆AppBuilder | - | - |
| 智能对话平台 | - | - | - | 文心一言 | - | - |
| 大模型知识引擎 | - | 大模型知识引擎 | - | - | - | - |
| 大模型图像创作引擎 | - | 大模型图像创作引擎 | - | - | - | - |
| 大模型视频创作引擎 | - | 大模型视频创作引擎 | - | - | - | - |
| 智能问答机器人 | - | - | 智能问答机器人 QABot | - | - | - |
| 视频智能分析 | - | - | 视频智能分析服务 VIAS | - | - | - |
| 智能标注 | - | - | 智能标注服务 ModelArts | - | - | - |
| 数据集管理 | - | - | 数据集管理服务 ModelArts | - | - | - |
| 智能客服平台 | - | - | - | 客悦智能客服平台 | - | - |
| 智能创作平台 | - | - | - | 一念智能创作平台 | - | - |
...
| 服务类型 | 阿里云 | 腾讯云 | 华为云 | 百度云 | 天翼云 | AWS |
|---------|--------|--------|--------|---------|---------|-----|
| 语音消息 | 语音服务 | 语音消息 | 语音通话服务 | - | 语音服务 | Amazon Polly |
...
| 短信服务 | 短信服务 | 短信 SMS | 消息&短信服务 | 短信服务 | 短信服务 | Amazon SNS |
| 实时音视频 | 音视频通信 RTC | 实时音视频 TRTC | 实时音视频 RTC | 音视频服务 | 实时音视频 | Amazon Chime SDK |
...
| 拨测监控 | 站点监控 | 云拨测 CAT | 实时探测 | - | - | Amazon CloudWatch Synthetics |
| Prometheus监控 | Prometheus监控 | Prometheus监控服务 TMP | Prometheus服务 | Prometheus监控服务 | - | Amazon Managed Prometheus |
...
| 服务类型 | 阿里云 | 腾讯云 | 华为云 | 百度云 | 天翼云 | AWS |
|---------|--------|--------|--------|---------|---------|-----|
| 消息队列RocketMQ | 消息队列RocketMQ | 消息队列 TDMQ RocketMQ | 分布式消息服务 DMS | 消息队列 BMQ | 消息队列 RocketMQ | Amazon MQ |
| 消息队列Kafka | 消息队列Kafka | 消息队列 TDMQ Kafka | 分布式消息服务Kafka | 消息队列Kafka | 消息队列Kafka | Amazon MSK |
| 消息队列RabbitMQ | 消息队列RabbitMQ | 消息队列 TDMQ RabbitMQ | 分布式消息服务 RabbitMQ | - | 消息队列 RabbitMQ | Amazon MQ for RabbitMQ |
...
| 服务类型 | 阿里云 | 腾讯云 | 华为云 | 百度云 | 天翼云 | AWS |
|---------|--------|--------|--------|---------|---------|-----|
| 域名注册 | 域名注册 | DNSPod域名注册 | 域名注册服务 | 域名服务 | 域名注册 | Amazon Route 53 Domains |
| 域名解析 | 云解析 DNS | DNSPod | 云解析服务 DNS | 智能DNS | 智能DNS | Amazon Route 53 |
...
| SSL证书 | SSL证书 | SSL证书 | SSL证书管理 | SSL证书 | SSL证书 | AWS Certificate Manager |
